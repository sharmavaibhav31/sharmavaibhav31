...
export const Footer: React.FC = () => (
    <footer className="py-8 border-t border-border dark:border-white/10" role="contentinfo">
        <div className="max-w-7xl mx-auto px-6 lg:px-16 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <p className="text-xs text-muted dark:text-white/30 font-medium">
            ...
            <div className="flex items-center gap-6">
                <a
                    ...
                    className="text-xs text-secondary dark:text-white/45 hover:text-primary dark:hover:text-white transition-colors link-underline font-medium"
                >
                    GitHub
                </a>
                <a
